...
$sql="select * from `allocate system`.allocatesystemforstudent where SupID ='$SUPID'";
                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">View Your Allocate Information</h3>
                        </li>
                    </ul>
                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Your Allocate Datatable</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            <tr class="tbContext">
                                                ...
                                                <th><?php echo $row["StudentEmail"]?></th>
